...
upper_bounds_count = [100000000, 100000000]
...
def ProcessMedian(scale, i, k):
	...
	write_file_median = open(cur_path + "/../Temp/aTPCH" + scale + "_" + queries[i] + "_median_" + str(k) + ".txt", 'w')
...
def ThresholdRunAlgorithm(js, j, i, epsilon, percent):
	...
	for k in js:
		...
		cmd = "../python/python " + cur_path + "/../Code/ComputeR_Sum" + folders[i] + ".py -I ../Information/TPCH/" + scales[j] + "/" + queries[i] + "_count.txt -e " + str(epsilon / 2) + " -b 0.1 -D " + str(int(upper_bounds_count[i] * math.pow(2, j))) + " -d " + str(int(error_levels_count[i])) + " -O ../Temp/aTPCH" + scales[j] + "_Sum" + folders[i] + "_" + queries[i] + "_count_" + str(epsilon / 2) + "_" + str(k) + ".txt"

		shell = os.popen(cmd, 'r')
		shell.read()
		shell.close()

		cmd = "../python/python " + cur_path + "/../Code/Exponential.py -I ../Temp/aTPCH" + scales[j] + "_Sum" + folders[i] + "_" + queries[i] + "_count_" + str(epsilon / 2) + "_" + str(k) + ".txt -e " + str(epsilon / 2) + " -b 0.1 -D " + str(int(upper_bounds_count[i] * math.pow(2, j))) + " -d " + str(int(error_levels_count[i]))
		...
		cmd = "../python/python " + cur_path + "/../Code/ComputeR_Selection" + folders[i] + ".py -I ../Temp/aTPCH" + scales[j] + "_" + queries[i] + "_median_" + str(k) + ".txt -e " + str(epsilon / 2) + " -b 0.1 -D " + str(upper_bounds[i] - lower_bounds[i]) + " -d " + str(error_levels[i]) + " -O ../Temp/aTPCH" + scales[j] + "_Selection" + folders[i] + "_" + queries[i] + "_" + str(epsilon) + "_median_" + str(k) + ".txt -k " + str(index)

		shell = os.popen(cmd, 'r')
		shell.read()
		shell.close()

		cmd = "../python/python " + cur_path + "/../Code/Exponential.py -I ../Temp/aTPCH" + scales[j] + "_Selection" + folders[i] + "_" + queries[i] + "_" + str(epsilon) + "_median_" + str(k) + ".txt -e " + str(epsilon / 2) + " -b 0.1 -D " + str(upper_bounds[i]) + " -d " + str(error_levels[i])
		...
		os.remove(cur_path + "/../Temp/aTPCH" + scales[j] + "_" + queries[i] + "_median_" + str(k) + ".txt")
		os.remove(cur_path + "/../Temp/aTPCH" + scales[j] + "_Sum" + folders[i] + "_" + queries[i] + "_count_" + str(epsilon / 2) + "_" + str(k) + ".txt")
		os.remove(cur_path + "/../Temp/aTPCH" + scales[j] + "_Selection" + folders[i] + "_" + queries[i] + "_" + str(epsilon) + "_median_" + str(k) + ".txt")
...
def main(argv):
	...
	cur_path = os.getcwd()
	output_file = open(cur_path + "/../Result/TPCH/ResultMedianScale.txt", 'w')
